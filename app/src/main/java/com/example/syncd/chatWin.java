...
public class chatWin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.msgadpter) == null) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    try {
                        ...
                        Log.d("ChatWin", "Sender image: " + senderImg);
                        Log.d("ChatWin", "Receiver image: " + reciverIImg);

                    } catch (Exception e) {
                        e.printStackTrace();
                        Toast.makeText(chatWin.this, "Crash cause: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }

                @Override
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(chatWin.this, "Firebase cancelled: " + error.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
