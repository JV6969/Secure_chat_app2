    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if (!emaill2.matches(emailPattern)) {
                                             ...
                                             if (task.isSuccessful()){
                                                 storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                     ...
                                                     public void onSuccess(Uri uri) {
                                                      ...
                                                      Users users = new Users(id,name2,emaill2,pass2,cpass2,imageuri);
                                                 ...
                                                 String status2 = "Hey!! i am using sync'd ";
                                                 imageuri = "https://firebasestorage.googleapis.com/v0/b/syncd6969.firebasestorage.app/o/22-223968_default-profile-picture-circle-hd-png-download.png?alt=media&token=0eafe101-49cc-43af-a86b-4e338fcb86fc";
